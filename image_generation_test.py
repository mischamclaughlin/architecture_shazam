...
from summarise_prompt import summarise_for_image
...
for model in model_description:
    start = time.time()
    summary = summarise_for_image(model_description[model])
...
for model in summaries:
    ...
    save_dir = os.path.abspath(f"./generated_images/tian_mi_mi/{safe_model}")
    # save_dir = os.path.abspath(f"./generated_images/guqin_solo/{safe_model}")
    # save_dir = os.path.abspath(f"./generated_images/fur_elise/{safe_model}")
